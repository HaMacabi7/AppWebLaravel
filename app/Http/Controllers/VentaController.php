...
class VentaController extends Controller
{
    ...
    public function store(Request $request)
    {
       $data = $this->validateData($request);
        ...
        try {
            ...
            Producto::updateStock(false,$ventaData['detalles']); //LLAMAR AL METODO UPDATESTOCK
    ...
    public function destroy($id)
    {
         try {
            ...
            Producto::updateStock(true,$registro->detalles->toArray()); //LLAMAR AL METODO UPDATESTOCK          
            $registro->delete();
