...
class CompraController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Producto::updateStock(true,$compraData['detalles']); //LLAMAR AL METODO UPDATESTOCK
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            Producto::updateStock(false,$compra->detalles->toArray());  //LLAMAR AL METODO UPDATESTOCK
    ...
    public function destroy($id)
    {
        try {
            ...
            Producto::updateStock(false,$registro->detalles->toArray()); //LLAMAR AL METODO UPDATESTOCK
            $registro->delete();
    ...
    public function printTicket($id){
        ...
        $empresa = (object)[
            'razon_social' => 'Hardline Systems Perú EIRL',
