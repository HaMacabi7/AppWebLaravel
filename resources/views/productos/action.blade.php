          ...
          <div class="row">
            ...
            <div class="col-log-12">
               <div class="form-group mb-3">
                ...
                <textarea id="descripcion" name="descripcion" class="form-control" rows="4" style="resize: vertical;"></textarea>
                <div class="invalid-feedback"></div>
              </div>
            </div>
            <div class="col-log-3">
             ...
             <div class="col-log-6">
              <div class="form-group mb-3">
                ...
                <div class="invalid-feedback"></div>
                <img src="" width="250px" alt="Imagen del producto" id="imagen_producto">
              </div>
            </div>
          </div>
        </div>
